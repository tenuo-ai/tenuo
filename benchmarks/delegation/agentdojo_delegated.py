...
from agentdojo.agent_pipeline import (
    ...
    InitQuery, ToolsExecutor, ToolsExecutionLoop, SystemMessage
)
from agentdojo.attacks import FixedJailbreakAttack
from agentdojo.attacks.baseline_attacks import DirectAttack, IgnorePreviousAttack
import agentdojo.logging as adlog

from tenuo import SigningKey, Warrant, Pattern, Range

from ..agentdojo.warrant_templates import get_constraints_for_suite, DELEGATION_NARROWING
...
class DelegationBenchmark:
    ...
    def run_comparison(
        ...
        results.delegation_prevented = results.assistant_blocked - results.manager_blocked
