...
Run with: python basic_protection.py
...
def main():
    ...
    search_tool = Tool(name="search", description="Search the web", func=search_web)
    read_tool = Tool(name="read_file", description="Read a file", func=read_file)
    email_tool = Tool(name="send_email", description="Send email", func=send_email)
