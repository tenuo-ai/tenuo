...
def print_user_task(task: str):
    ...
    console.print(Panel(f"[bold]{task}[/bold]", title="📝 User Task", border_style="white"))
...
def print_delegation(from_key, worker_name: str, to_key, tools: list, constraints: dict, ttl: int):
