...
export const sdkcontext_issuerPublicKey: (a: number) => [number, number, number, number];
...
export const approval_requirement: (a: number, b: number, c: number, d: number, e: any) => any;
