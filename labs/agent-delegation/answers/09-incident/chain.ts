/**
 * Reference solution for stage 9. Stage 6's chain, with the hotel branch terminal.
 *
 ...
 * with its own holder key. Core refuses any link that is not within its
 * parent before a token exists.
 */
