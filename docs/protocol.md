...
Even if cycles somehow formed, verification stops at depth 64.
...
| Chain > 64 depth | [BLOCKED] | DoS protection |

### Scaling Delegation (Trust Anchors)

The 64-depth limit is generous for typical hierarchies. You can also distribute intermediate CA keys (Trust Anchors) to the Authorizer for verification shortcuts.
