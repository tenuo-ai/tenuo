...
protected = guard_tools([DuckDuckGoSearchRun()])
```

**How `guard_tools()` extracts arguments:**
...
See [MCP Integration](./mcp) for full details.
...
### Python Signature Binding (decorators.py)
