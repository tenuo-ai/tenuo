...
| [ci-gateway-v1.md](ci-gateway-v1.md) | Tenuo for GitHub Actions — warrant-as-program, `secret` chart, Cloud issuer contract (not protocol-normative). I10 (`kms`) is specified, not in the image yet. |
