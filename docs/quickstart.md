...
> **Rust SDK**: If you're using Rust directly, add `tenuo = "0.1.0-beta.2"` to your `Cargo.toml`. See the [crates.io documentation](https://crates.io/crates/tenuo) for Rust-specific examples. This guide focuses on Python.
