...
<figure class="lab-figure"><svg class="lab-diagram" viewBox="0 0 760 406" role="img" aria-label="The bytes travel. The right to use them does not." xmlns="http://www.w3.org/2000/svg"><path d="M100 144 L100 288" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><path d="M100 204 L215 204" fill="none" stroke="#3a3a3a" stroke-width="1.5"/><polygon points="215,204 207,199 207,209" fill="#3a3a3a"/><path d="M100 288 L215 288" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><polygon points="215,288 207,283 207,293" fill="#5a5a5a"/><path d="M170 120 L215 120" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><polygon points="215,120 207,115 207,125" fill="#5a5a5a"/><path d="M355 120 L400 120" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><polygon points="400,120 392,115 392,125" fill="#5a5a5a"/><path d="M540 120 L585 120" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><polygon points="585,120 577,115 577,125" fill="#5a5a5a"/><rect x="30" y="18" width="140" height="40" rx="8" fill="var(--surface-2)" stroke="var(--accent)" stroke-width="2"/><text x="42" y="39" font-size="13" font-weight="600" fill="var(--text)">Control plane</text><text x="42" y="56" font-size="11" fill="var(--text-muted)">signs the root</text><path d="M100 58 L100 96" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><polygon points="100,96 95,88 105,88" fill="#5a5a5a"/><rect x="30" y="96" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="42" y="125" font-size="13" font-weight="600" fill="var(--text)">Travel Agent</text><rect x="215" y="96" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="227" y="125" font-size="13" font-weight="600" fill="var(--text)">Flight Agent</text><rect x="215" y="180" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="227" y="209" font-size="13" font-weight="600" fill="var(--text)">Hotel Agent</text><rect x="215" y="264" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="#ff5c5c" stroke-width="2"/><text x="227" y="285" font-size="13" font-weight="600" fill="var(--text)">Activity Agent</text><text x="227" y="302" font-size="11" fill="var(--text-muted)">has a copy of it</text><rect x="305" y="255" width="44" height="16" rx="8" fill="#ff5c5c"/><text x="327" y="267" font-size="10" font-weight="700" text-anchor="middle" fill="#0a0a0a">thief</text><rect x="400" y="96" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="412" y="125" font-size="13" font-weight="600" fill="var(--text)">Check-in Agent</text><rect x="585" y="96" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="#3ddc84" stroke-width="2"/><text x="597" y="117" font-size="13" font-weight="600" fill="var(--text)">Boarding Agent</text><text x="597" y="134" font-size="11" fill="var(--text-muted)">holds UA214 boarding pass</text><path d="M655 144 C 655 298, 285 298, 285 262" fill="none" stroke="#ff5c5c" stroke-width="2" stroke-dasharray="6 4"/><polygon points="285,262 280,254 290,254" fill="#ff5c5c"/><text x="470" y="296" font-size="10.5" text-anchor="middle" fill="#ff5c5c">copied bytes</text><text x="380" y="398" font-size="12" text-anchor="middle" fill="var(--text-muted)">The bytes travel. The right to use them does not.</text></svg></figure>
