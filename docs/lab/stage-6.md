...
<figure class="lab-figure"><svg class="lab-diagram" viewBox="0 0 760 414" role="img" aria-label="Each hop can only narrow. The root has to carry everything anyone below will ever need." xmlns="http://www.w3.org/2000/svg"><rect x="30" y="12" width="700" height="46" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="44" y="41" font-size="13" font-weight="600" fill="var(--text)">Control plane</text><text x="220" y="41" font-size="12.5" fill="var(--text-muted)">signs the trip permission for Travel Agent</text><rect x="525.8" y="26" width="194.2" height="18" rx="9" fill="var(--border)"/><text x="622.9" y="39" font-size="10.5" font-weight="700" text-anchor="middle" fill="var(--text-muted)">signed by the control plane</text><path d="M120 58 L120 90" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><polygon points="120,90 115,82 125,82" fill="#5a5a5a"/><text x="128" y="78" font-size="10.5" text-anchor="start" fill="var(--text-muted)">narrows</text><rect x="30" y="92" width="700" height="46" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="44" y="121" font-size="13" font-weight="600" fill="var(--text)">Travel Agent</text><text x="220" y="121" font-size="12.5" fill="var(--text-muted)">Alice → Cancún, up to $1,200, any flight this trip books</text><rect x="605" y="106" width="115" height="18" rx="9" fill="var(--border)"/><text x="662.5" y="119" font-size="10.5" font-weight="700" text-anchor="middle" fill="var(--text-muted)">written for you</text><path d="M120 138 L120 170" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><polygon points="120,170 115,162 125,162" fill="#5a5a5a"/><text x="128" y="158" font-size="10.5" text-anchor="start" fill="var(--text-muted)">narrows</text><rect x="30" y="172" width="700" height="46" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="44" y="201" font-size="13" font-weight="600" fill="var(--text)">Flight Agent</text><text x="220" y="201" font-size="12.5" fill="var(--text-muted)">Cancún flights, up to $300, flight's share of the wallet</text><rect x="605" y="186" width="115" height="18" rx="9" fill="var(--border)"/><text x="662.5" y="199" font-size="10.5" font-weight="700" text-anchor="middle" fill="var(--text-muted)">written for you</text><path d="M120 218 L120 250" fill="none" stroke="var(--accent)" stroke-width="2" stroke-dasharray="6 4"/><polygon points="120,250 115,242 125,242" fill="var(--accent)"/><text x="128" y="238" font-size="10.5" text-anchor="start" fill="var(--accent)">narrows to the flight it booked</text><rect x="30" y="252" width="700" height="46" rx="8" fill="var(--surface-2)" stroke="var(--accent)" stroke-width="2"/><text x="44" y="281" font-size="13" font-weight="600" fill="var(--text)">Check-in Agent</text><text x="220" y="281" font-size="12.5" fill="var(--text-muted)">UA214 only: read, check in, hand the boarding pass on</text><rect x="611.6" y="266" width="108.39999999999999" height="18" rx="9" fill="var(--accent)"/><text x="665.8" y="279" font-size="10.5" font-weight="700" text-anchor="middle" fill="#0a0a0a">you write this</text><path d="M120 298 L120 330" fill="none" stroke="var(--accent)" stroke-width="2" stroke-dasharray="6 4"/><polygon points="120,330 115,322 125,322" fill="var(--accent)"/><text x="128" y="318" font-size="10.5" text-anchor="start" fill="var(--accent)">narrows</text><rect x="30" y="332" width="700" height="46" rx="8" fill="var(--surface-2)" stroke="var(--accent)" stroke-width="2"/><text x="44" y="361" font-size="13" font-weight="600" fill="var(--text)">Boarding Agent</text><text x="220" y="361" font-size="12.5" fill="var(--text-muted)">UA214 only: issue the boarding pass</text><rect x="611.6" y="346" width="108.39999999999999" height="18" rx="9" fill="var(--accent)"/><text x="665.8" y="359" font-size="10.5" font-weight="700" text-anchor="middle" fill="#0a0a0a">you write this</text><text x="380" y="406" font-size="12" text-anchor="middle" fill="var(--text-muted)">Each hop can only narrow. The root has to carry everything anyone below will ever need.</text></svg></figure>
