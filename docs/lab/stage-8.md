...
description: "Make one hop the end of the line and watch the chain stop where the *previous* agent decided it would."
lab_stage: 8
---
...
<header class="lab-hero"><div class="lab-kicker">Stage 8 of 9 · <span class="lab-mode tenuo">tenuo</span> · about 10 min</div><h1>How far can this travel?</h1><p class="lab-goal"><strong>Goal.</strong> Make one hop the end of the line and watch the chain stop where the <em>previous</em> agent decided it would.</p></header>
...
<p class="lab-intro">This stage is supposed to break the trip. Notice where, and who decided.</p>

<figure class="lab-figure"><svg class="lab-diagram" viewBox="0 0 760 362" role="img" aria-label="Flight Agent decided. Check-in Agent did not agree and cannot undo it." xmlns="http://www.w3.org/2000/svg"><path d="M100 144 L100 288" fill="none" stroke="#3a3a3a" stroke-width="1.5"/><path d="M100 204 L215 204" fill="none" stroke="#3a3a3a" stroke-width="1.5"/><polygon points="215,204 207,199 207,209" fill="#3a3a3a"/><path d="M100 288 L215 288" fill="none" stroke="#3a3a3a" stroke-width="1.5"/><polygon points="215,288 207,283 207,293" fill="#3a3a3a"/><path d="M170 120 L215 120" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><polygon points="215,120 207,115 207,125" fill="#5a5a5a"/><path d="M355 120 L400 120" fill="none" stroke="#ffb000" stroke-width="2"/><line x1="399" y1="111" x2="399" y2="129" stroke="#ffb000" stroke-width="3"/><text x="377.5" y="159" font-size="10.5" text-anchor="middle" fill="#ffb000">terminal</text><path d="M540 120 L585 120" fill="none" stroke="#ff5c5c" stroke-width="2"/><polygon points="585,120 577,115 577,125" fill="#ff5c5c"/><text x="562.5" y="125" font-size="15" font-weight="700" text-anchor="middle" fill="#ff5c5c">✕</text><text x="562.5" y="159" font-size="10.5" text-anchor="middle" fill="#ff5c5c">TENUO_DEPTH_EXCEEDED</text><rect x="30" y="18" width="140" height="40" rx="8" fill="var(--surface-2)" stroke="var(--accent)" stroke-width="2"/><text x="42" y="39" font-size="13" font-weight="600" fill="var(--text)">Control plane</text><text x="42" y="56" font-size="11" fill="var(--text-muted)">maxDepth: 4</text><path d="M100 58 L100 96" fill="none" stroke="#5a5a5a" stroke-width="1.5"/><polygon points="100,96 95,88 105,88" fill="#5a5a5a"/><rect x="30" y="96" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="42" y="125" font-size="13" font-weight="600" fill="var(--text)">Travel Agent</text><rect x="215" y="96" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="var(--accent)" stroke-width="2"/><text x="227" y="117" font-size="13" font-weight="600" fill="var(--text)">Flight Agent</text><text x="227" y="134" font-size="11" fill="var(--text-muted)">marks the handoff terminal</text><rect x="215" y="180" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="227" y="209" font-size="13" font-weight="600" fill="var(--text)">Hotel Agent</text><rect x="215" y="264" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="227" y="293" font-size="13" font-weight="600" fill="var(--text)">Activity Agent</text><rect x="400" y="96" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="var(--border)" stroke-width="1"/><text x="412" y="117" font-size="13" font-weight="600" fill="var(--text)">Check-in Agent</text><text x="412" y="134" font-size="11" fill="var(--text-muted)">cannot pass it on</text><rect x="585" y="96" width="140" height="48" rx="8" fill="var(--surface-2)" stroke="#3a3a3a" stroke-width="1"/><text x="597" y="117" font-size="13" font-weight="600" fill="var(--text-muted)">Boarding Agent</text><text x="597" y="134" font-size="11" fill="var(--text-muted)">never receives it</text><text x="380" y="354" font-size="12" text-anchor="middle" fill="var(--text-muted)">Flight Agent decided. Check-in Agent did not agree and cannot undo it.</text></svg></figure>
...
<details class="lab-reveal answer"><summary>Show a reference solution</summary><div><p class="lab-muted">Try yours first. The score does not care whether it matches this one.</p><figure class="lab-code"><figcaption>One option added <span>answers/08-terminal/chain.ts</span></figcaption>
{% highlight ts %}
/**
