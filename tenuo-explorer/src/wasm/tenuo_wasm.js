 ...
 * @returns {any}
 */
export function check_access(warrant_b64, tool, args_json, trusted_root_hex, dry_run) {
 ...
 * @returns {any}
 */
export function check_access_with_pop(warrant_b64, tool, args_json, trusted_root_hex, pop_signature_hex) {
    const ptr0 = passStringToWasm0(warrant_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(tool, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function create_sample_warrant(tool, constraint_field, constraint_pattern, ttl_seconds) {
 ...
 * @returns {any}
 */
export function decode_warrant(base64_warrant) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('tenuo_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
